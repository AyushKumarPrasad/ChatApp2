...
public class AllUsersActivity extends AppCompatActivity
{
    ...
    public static final String STORAGE_PATH = "Users";
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        allDatabaseUsersreference = firebaseDatabase.getInstance().getReference("Users");
        allDatabaseUsersreference.keepSynced(true);

        mToolbar = (Toolbar) findViewById(R.id.all_users_app_bar_ayush);
        ...
        Toast.makeText(AllUsersActivity.this,"Wait !! Fetching List",Toast.LENGTH_SHORT).show();
    }
    ...
    public static class AllUsersViewHolder extends RecyclerView.ViewHolder
    {
        ...
        public AllUsersViewHolder(final View itemView)
        {
            super(itemView);
           ...
           final CircleImageView thumb_image = (CircleImageView) mView.findViewById(R.id.all_users_profile_image);
            ...
            Picasso.with(ctx).load(user_thumb_image).networkPolicy(NetworkPolicy.OFFLINE)
                    ...
                    .into(thumb_image, new Callback()
                    {
                        ...
                        public void onError()
                        {
                            Picasso.with(ctx).load(user_thumb_image).placeholder(R.drawable.defaultimage)
                                    .into(thumb_image);
                        }
                    });
        }
